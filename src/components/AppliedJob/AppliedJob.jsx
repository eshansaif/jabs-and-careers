    ...
    return (
        <div className="mb-4">
            ...
            <div className="card w-100 bg-base-100 border rounded">
                <div className="flex md:flex-row flex-col justify-between items-center p-7 gap-4">
                    <div className="flex gap-10 md:flex-row flex-col">
                        <div>
                            <img className="object-fill h-48 w-96 bg-gray-200 " src={company_logo} alt={company_name} />
                        </div>
                        <div>
